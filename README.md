...
<table>
    ...
    <tr>
        <td>Web 321 - (M318)</td>
        <td>Summer - 2024</td>
        <td>Business Environment for Web Professionals (2247-DD)</td>
        <td>
            <p>
                This course covers skills required by web developers that support the business side of web development and augment coding skills. Topics include marketing techniques, business/client needs, business skills, business communication, organization and team development, and leveraging communities of interest.
            </p>
        </td>
    </tr>
    <tr>
        <td>SPCC - (Career Readiness)</td>
        <td>Summer - 2024</td>
        <td>Sophia Learning - Career Readiness</td>
        <td>
            <p>
                You will identify the fundamental steps to secure a job role by:
                <ul>
                    <li>
                        explaining the process of selecting and applying to a job.
                    </li>
                    <li>
                        creating career readiness documents
                    </li>
                    <li>
                        communicating effective skills and relevant experience during a job interview
                    </li>
                    <li>
                        applying strategies to increase professionalism and employability skills.
                    </li>
                </ul>
            </p>
        </td>
    ...
    <tr>
        <td>SPCC - (Criminology)</td>
        <td>Summer - 2024</td>
        <td>Sophia Learning - Criminology</td>
        <td>
            <p>
                You will assess victimology, the critiques of existing theories, and future models of criminology by:
                <ul>
                    <li>
                        Indicating the components, impacts, and critiques of victimology.
                    </li>
                    <li>
                        Identifying the concepts and critiques within environmental and feminist criminology.
                    </li>
                    <li>
                        Comparing how the existing theories of criminology relate to future models of criminology.
                    </li>
                </ul>
            </p>
        </td>
